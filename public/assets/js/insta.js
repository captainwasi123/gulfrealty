/*1760456122,,JIT Construction: v1028352631,en_US*/
                                        ...
                                        if (!s("json")) {
                                            ...
                                            (o = b.hasOwnProperty) ||
                                                (o = function (a) {
                                                    var b = {},
                                                        c;
                                                    ((b.__proto__ = null), (b.__proto__ = { toString: 1 }), b)
                                                        .toString != n
                                                        ? (o = function (a) {
                            ...
                            function w(a) {
                                ...
                                a == null || typeof a !== "object"
                                    ...
                                    : Object.prototype.hasOwnProperty.call(a, ba)
                                      ? (b = i("Rescript exception thrown: %s", ES("JSON", "stringify", !1, a)))
                                      : typeof (a === null || a === void 0 ? void 0 : a.then) === "function"
                                        ? (b = i("Promise thrown: %s", ES("JSON", "stringify", !1, a)))
                            ...
                            var y = {
                                ...
                                A = {
                                    ...
                                    findDeferredSource: function () {
                                        for (var a of z) if (a.deferredSource != null) return a.deferredSource;
                                    },
                                };
                            function ea(a) {
                                            ...
                                            try {
                                                ...
                                                g == null &&
                                                    ...
                                                    c != null &&
                                                        c.length &&
                                                        (d.extra[
                                                            ES("Array", "from", !1, c).toString().substring(0, 100)
                                                        ] = "args"));
                            ...
                            function Aa(a) {
                                ...
                                try {
                                    (f =
                                        e === c && f != null && f !== ""
                                            ? f
                                            : typeof (c === null || c === void 0 ? void 0 : c.name) === "string" &&
                                                c.name !== ""
                                              ? c.name
                                              : d != null && d.length > 0
                                ...
                                setup: function (a, b, c) {
                                    R.addListener(function (d) {
                                        ...
                                        e = babelHelpers["extends"](
                                            {},
                                            a,
                                            (e = c === null || c === void 0 ? void 0 : c()) !== null && e !== void 0
                                                ? e
                                                : {}
                                        );
                                        ya.postError(d, e, b);
                                    ...
                                    b.getTagString = function () {
                                        var a =
                                            this.loggerTags.size > 0
                                                ? "[" + ES("Array", "from", !1, this.loggerTags).join("|") + "] "
                                                : "";
                                        return a;
                                    };
                                    return a;
                    ...
                    __d(
                        ...
                        function (a, b, c, d, e, f, g) {
                            a = (function () {
                                function a(a) {
                                    if (a <= 0)
                                        throw c("FBLogger")("comet_infra").mustfixThrow(
                    ...
                    __d(
                        ...
                        function (a, b, c, d, e, f, g) {
                            ...
                            function b(b, d) {
                                ...
                                for (var f = arguments.length, g = new Array(f > 2 ? f - 2 : 0), i = 2; i < f; i++)
                                    g[i - 2] = arguments[i];
                    ...
                    __d(
                        ...
                        function (a, b, c, d, e, f, g) {
                            ...
                            if ((h || c("ExecutionEnvironment")).canUseDOM) {
                                ...
                                d ||
                                    ((i = []),
                                    c("CometEventListener").listen(document, "DOMContentLoaded", a),
                                    c("CometEventListener").listen(window, "load", a));
                            }
                            g["default"] = b;
                        },
                        98
                                ...
                                for (d of d) {
                                    ...
                                    for (h of h) {
                                        var i = h[0],
                                            k = h[1];
                                        for (k of k[1])
                                            k >= b && k <= c && e.push({ module: a, ref: g || null, type: i, time: k });
                                    }
                                }
                                    ...
                                    a = function () {
                                        ...
                                        c[d] = e
                                            ? new g(function (b, c) {
                                                  a.then(
                                                      function (a) {
                                                          b({ status: "fulfilled", value: a });
                                                      },
                                                      function (a) {
                                                          b({ status: "rejected", reason: a });
                                                      }
                                                  );
                                              })
                                            : g.resolve({ status: "fulfilled", value: a });
                                    };
                            ...
                            function s(a) {
                                ...
                                b == null
                                    ...
                                    : b === j
                                      ...
                                      : Math.floor(Math.random() * b) === 0 && l(a, b);
                            }
                            function t(a) {
                                q.push(a);
                            }
                        ...
                        function (a, b, c, d, e, f, g, h) {
                            ...
                            function Q(a) {
                                if (
                                    ...
                                    b &&
                                        ...
                                        "fetchStart" in b[0] &&
                                        "responseEnd" in b[0] &&
                                        a(b[0].fetchStart, b[0].responseEnd);
                                }
                            }
                            function R(a, b) {
                                var c = I++,
                                        ...
                                        P(function (a) {
                                            K[d] &&
                                                ...
                                                window.__igEmbedLoaded &&
                                                    window.__igEmbedLoaded({ frameId: d, stats: K[d] }));
                                        });
                                        break;
                            ...
                            function V() {
                                ...
                                c("polarisOnDOMReady")(function () {
                                    U(),
                                        G ||
                                            (c("CometEventListener").listen(window, "message", function (a) {
                                                T(a);
                                            }),
                                            (G = !0));
                                });
                            ...
                            function a() {
                                d("PolarisEmbedSDKContext").getGlobalContext().process ||
                                    (V(), (d("PolarisEmbedSDKContext").getGlobalContext().process = V));
                            }
                            g.init = a;
                        },
                        98
    ...
    __fb_i.src =
        ...
        encodeURIComponent(
            '{"error":"LOAD", "extra": {"name":"' +
                ...
                '","script":"' +
                (__fb_err.fileName || __fb_err.sourceURL || __fb_err.script || "embed.js") +
                '","stack":"' +
                (__fb_err.stackTrace || __fb_err.stack) +
                '","revision":"1028352631","namespace":"FB","message":"' +
                __fb_err.message +
                '"}}'
        );
