            ...
            <div class="card-header">
              <div class="row">
                <div class="col-md-9 searchbar">
                  <input type="text" name="retailer" placeholder="Search for videos..." class="form-control searchBlog">
...
<div class="modal fade" id="addBlogFormModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="add_blog_form" action="{{route('admin.gallery.videos.create')}}">
        @csrf
...
<script>
  ...
  $(function() {
    ...
    $(document).on('keyup', '.searchBlog', function() {
      ...
      var url = "{{URL::to('/admin/panel/gallery/videos/search')}}/" + val;
    ...
    $(document).on('click', '.deleteEpisode', function() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.get("{{URL::to('/admin/panel/gallery/videos/delete')}}/" + id, function(data) {
            Toast.fire({
              icon: 'success',
    ...
    $(document).on('click', '.editBlog', function() {
      ...
      $.get("{{URL::to('/admin/panel/gallery/videos/edit')}}/" + id, function(data) {
  ...
  function loadBlogs() {
    ...
    $pu = ($pu == 0 ? '' : '?page='.$pu);
    @endphp
    var url = "{{route('admin.gallery.videos.load').$pu}}";
