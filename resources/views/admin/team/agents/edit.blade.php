<form method="post" action="{{route('admin.team.agents.update')}}" enctype="multipart/form-data">
@csrf
...
<div class="modal-body">
  <div class="row">
    <div class="col-md-12">
      <img src="{{URL::to('/public/storage/team/agents/'.$data->image)}}" height="120px">
      <br>
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="property_sold" value="{{$data->property_sold}}" required>
      </div>
    </div>
    <div class="col-md-12">
      <div class="form-group">
