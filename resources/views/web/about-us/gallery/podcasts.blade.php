            ...
            <div class="d-flex align-items-center justify-content-between gap-4">
              <div class="overflow-x-auto">
                <ul class="nav nav-pills flex-nowrap gap-2">
                  ...
                  <li class="nav-item me-1">
                    <a class="nav-link text-nowrap active" aria-current="page" href="javascript:void(0)">Podcasts</a>
                  </li>
                  <li class="nav-item me-1">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-2 row-cols-xl-3 g-4 g-sm-3 g-lg-4">
              ...
              <div class="col">
                <div class="card video-card">
                  <div class="card-body">
                    <iframe width="101%" height="250" src="https://www.youtube.com/embed/e5omgZHHR8E?si=GsJ2N8cbLxHXWsJI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  </div>
                </div>
              </div>
