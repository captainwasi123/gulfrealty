          ...
          <div class="row row-cols-1 row-cols-md-2 g-4 g-md-3 g-xl-4">
            <div class="col">
              ...
              <article class="hover-effect-scale position-relative bg-body-tertiary rounded overflow-hidden h-100">
                ...
                <img src="{{URL::to('/public')}}/assets/img/listings/real-estate/featured/01.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">
                  ...
                  <div class="d-flex align-items-end h-100 p-lg-2 p-xl-3">
                    <div class="d-flex flex-wrap align-items-center justify-content-between w-100 gap-3">
                      <div class="mb-1 mb-sm-0">
                        <h3 class="text-white d-flex flex-wrap align-items-center mb-1 mb-lg-2">3-bed apartment<span class="fs-6 fw-medium mx-2">|</span><span class="fs-6">127 sq.m</span></h3>
                        <p class="fs-sm text-white mb-0">3811 Ditmars Blvd Astoria, NY 11105</p>
                      </div>
                      <a class="btn btn-primary stretched-link" href="single-entry-real-estate.html">From $3,850</a>
                    </div>
                  </div>
                </div>
            ...
            <div class="col vstack gap-4 gap-md-3 gap-xl-4">
              ...
              <article class="hover-effect-scale position-relative bg-body-tertiary rounded overflow-hidden">
                ...
                <img src="{{URL::to('/public')}}/assets/img/listings/real-estate/featured/02.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">
                <div class="ratio d-none d-sm-block" style="--fn-aspect-ratio: calc(307 / 636 * 100%)"></div>
                <div class="ratio d-sm-none" style="--fn-aspect-ratio: calc(410 / 636 * 100%)"></div>
                <div class="position-absolute top-0 start-0 w-100 h-100 z-1 p-3">
                  <div class="d-flex align-items-end h-100 p-lg-2 p-xl-3">
                    <div class="d-flex flex-wrap align-items-center justify-content-between w-100 gap-3">
                      ...
                      <a class="btn btn-primary stretched-link" href="single-entry-real-estate.html">From $2,600</a>
                    </div>
                  </div>
                </div>
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark d-sm-none" style="opacity: .4"></span>
              ...
              <article class="hover-effect-scale position-relative bg-body-tertiary rounded overflow-hidden">
                ...
                <img src="{{URL::to('/public')}}/assets/img/listings/real-estate/featured/03.jpg" class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">
                <div class="ratio d-none d-sm-block" style="--fn-aspect-ratio: calc(307 / 636 * 100%)"></div>
                <div class="ratio d-sm-none" style="--fn-aspect-ratio: calc(410 / 636 * 100%)"></div>
                <div class="position-absolute top-0 start-0 w-100 h-100 z-1 p-3">
                  <div class="d-flex align-items-end h-100 p-lg-2 p-xl-3">
                    <div class="d-flex flex-wrap align-items-center justify-content-between w-100 gap-3">
                      <div class="mb-1 mb-sm-0">
                        <h3 class="text-white d-flex flex-wrap align-items-center mb-1 mb-lg-2">1-bed apartment<span class="fs-6 fw-medium mx-2">|</span><span class="fs-6">52 sq.m</span></h3>
                        <p class="fs-sm text-white mb-0">444 Park Ave, Brooklyn, NY 11205</p>
                      </div>
                      <a class="btn btn-primary stretched-link" href="single-entry-real-estate.html">From $1,750</a>
                    </div>
                  </div>
                </div>
                <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark d-sm-none" style="opacity: .4"></span>
